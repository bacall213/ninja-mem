...
exports.echo = function(opts,params,cb) {
  ...
  if (payloadToSend.contents[1]) {
    payloadToSend.contents[1].text = "The Ninja RAM Monitor will update every " + params.poll_interval + " seconds.";
  } else {
    payloadToSend.contents.push({ "type": "paragraph", "text": "The Ninja RAM Monitor will update every " + params.poll_interval + " seconds." });
